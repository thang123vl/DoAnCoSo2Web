<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonHangDaMuaNV.aspx.cs" Inherits="WebApplication1.DonHangDaMuaNV" %>
        ...
        <div class="content">
            <div class="table-container">
                ...
                <table>
                    ...
                    <tbody>
                        <%for (int i=0;i<listhdb.Count;i++){ %>
                            <tr>
                            <td><%=listhdb[i].MaHDBan %></td>
                             <td><%=listhdb[i].TenKH %></td>
                             <td><%=listhdb[i].NgayBan %></td>
                                <td><%=listhdb[i].TongTien %></td>
                            </tr>
                        <%} %>
