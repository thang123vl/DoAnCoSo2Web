<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nhaphang.aspx.cs" Inherits="WebApplication1.WebForm7" %>
...
#btnXacNhan, #btnThem ,#btnThemTatCa {
    width: 140px;
    margin: 20px auto;
    padding: 10px;
...
#btnXacNhan:hover, #btnThemTatCa:hover,#btnThem:hover {
...
<div class="menu">
    ...
    <!-- Nhập hàng -->
    <a href="nhaphang.aspx" class="add-button1"><i class="fas fa-box-open"></i> NHẬP HÀNG</a>
    ...
    <a href="nhanvien.aspx" class="add-button"><i class="fas fa-user-tie"></i> QUẢN LÍ NHÂN VIÊN</a>
     ...
     <a href="KhachHang.aspx" class="add-button"><i class="fas fa-users"></i> KHÁCH HÀNG</a>
            ...
            <div class="table-container">
                ...
                <!-- Form for selecting product, employee, quantity, and price -->
                <div>
                    <label for="chonSP">Chọn Sản Phẩm:</label>
                    <asp:DropDownList ID="chonSP" runat="server"></asp:DropDownList>

                    <label for="chonNhanVien">Chọn Nhân Viên:</label>
                    <asp:DropDownList ID="chonNhanVien" runat="server"></asp:DropDownList>

                    <label for="soLuong">Số Lượng:</label>
                    <asp:TextBox ID="txtSoLuong" runat="server" TextMode="Number" Min="1" Max="100"></asp:TextBox>

                    <label for="gianhap">Đơn Giá:</label>
                    <asp:TextBox ID="txtDonGia" runat="server" TextMode="Number" Min="1" Max="200000000000"></asp:TextBox>
                ...
                <asp:ListView ID="ListView1" runat="server" >
                    ...
                    <ItemTemplate>
                        <tr>
                            <td><asp:Label ID="lblTenSP" runat="server" Text='<%# Eval("TenThuoc") %>'></asp:Label></td>
                            <td><asp:Label ID="lblSoLuong" runat="server" Text='<%# Eval("SoLuong") %>'></asp:Label></td>
                            <td><asp:Label ID="lblGiaNhap" runat="server" Text='<%# Eval("DonGia") %>'></asp:Label></td>
                            <td><asp:Label ID="Label1" runat="server" Text='<%# Eval("MaNV") %>'></asp:Label></td>
                            <td>
                                <asp:Button ID="btnXoa" runat="server" Text="Xóa" CommandName="Xoa" CommandArgument='<%# Eval("TenThuoc") %>' OnClick="btnXoa_Click" />
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:ListView>
                <asp:Button ID="btnXacNhan" runat="server" Text="Xác Nhận" OnClick="btnXacNhan_Click" />
                    <asp:Button ID="btnThemTatCa" runat="server" Text="Thêm Tất Cả Thuốc" OnClick="btnThemTatCa_Click" CssClass="btn btn-primary" />
