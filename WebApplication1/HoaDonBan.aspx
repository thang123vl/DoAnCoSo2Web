<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HoaDonBan.aspx.cs" Inherits="WebApplication1.HoaDonBan" %>
...
<asp:ListItem Text="không chọn" Value="0" /> 
    ...
    <asp:DropDownList ID="ddlYear" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged">
        ...
        <asp:ListItem Text="2025" Value="2025" />
            ...
            <asp:TextBox ID="txtTimKiem" runat="server" CssClass="search-box" Placeholder="Nhập Mã Hóa Đơn Cần Tìm"></asp:TextBox>
...
<%for (int i=0;i<hdb.Count;i++) {%>
   <tr>
       <td>
         ...
         <td>
           <%=hdb[i].TongTien.ToString() %>
       </td>
       <td>                   
           <div class="action-buttons">
             <a href="inhoadonban.aspx?idhd=<%=hdb[i].MaHDBan %>" id="btnAdd" class="button-link">Xem Thống Kê</a>
             </div>
