<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KhachHang.aspx.cs" Inherits="WebApplication1.KhachHang1" %>
     ...
     <a href="KhachHang.aspx" class="add-button"><i class="fas fa-users"></i> KHÁCH HÀNG</a>
        ...
        <div class="content">
            ...
            <div class="search-container">
                <asp:TextBox ID="txtTimKiem" runat="server" CssClass="search-box" Placeholder="Nhập tên Khách Hàng.."></asp:TextBox>
       ...
       <% for (int i=0;i<kh.Count;i++){ %>
                            <tr>
                                ...
                                <a href="DonHangDaMuaNV.aspx?idkh=<%= kh[i].MaKH %>" class="delete">Những Đơn hàng đã mua</a>
                                    </div>
                                </td>
                            </tr>
           <%} %>
