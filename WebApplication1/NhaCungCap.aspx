<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NhaCungCap.aspx.cs" Inherits="WebApplication1.NhaCungCap1" %>
     ...
     <a href="KhachHang.aspx" class="add-button"><i class="fas fa-users"></i> KHÁCH HÀNG</a>
        ...
        <div class="content">
            ...
            <div class="search-container">
                <asp:TextBox ID="txtTimKiem" runat="server" CssClass="search-box" Placeholder="Nhập tên Nhà Cung Cấp..."></asp:TextBox>
                ...
                <table>
                    ...
                    <tbody>
                            ...
                            <tr>
                                 ...
                                 <td><%=ncc[i].MaCN %></td>
                                 <td><%=ncc[i].TenNCC %></td>
                                 <td><%=ncc[i].DiaChiNCC %></td>
                                 <td><%=ncc[i].SDT %></td>
                                 <td><%=ncc[i].Email %></td>
                                 <td><%=ncc[i].GhiChu %></td>
                                <td>
                                    <div class="action-buttons">
                                        <a href="NhaCungCap.aspx?action=delete&MaNCC=<%= ncc[i].MaNCC %>" class="delete" onclick="return confirm('Bạn chắc chắn muốn xóa nhân viên này?');">Xóa</a>
                                       <a href="nhacungcapdacungcap.aspx?idncc=<%= ncc[i].MaNCC %>" class="delete">Xem</a>
