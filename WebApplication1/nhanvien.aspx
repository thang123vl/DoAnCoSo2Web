<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nhanvien.aspx.cs" Inherits="WebApplication1.nhanvien" %>
...
<div class="menu">
                            ...
                            <tr>
                                ...
                                <td>    
                                    <div class="action-buttons">
                                        <!-- Liên kết sửa thuốc với ID -->
                                        <a href="suanhannv.aspx?idnv=<%= nv[i].MaNV %>" class="edit">Sửa</a>
                                        <a href="taikhoan.aspx?idtk=<%= nv[i].MaNV %>" class="edit">Hồ Sơ</a>
                                        <!-- Liên kết xóa nhân viên -->
                                        <a href="nhanvien.aspx?action=delete&maNV=<%= nv[i].MaNV %>" class="delete" onclick="return confirm('Bạn chắc chắn muốn xóa nhân viên này?');">Xóa</a>
                                    </div>
                                </td>
                            </tr>
                        <% } %>
    ...
    <a href="nhanvienbanchay.aspx" id="btnhh" class="button-link">
        <i class="fas fa-exclamation-triangle"></i> Top Những Nhân Viên Bán Chạy
    </a>
               <a href="ThemNhanVien.aspx" id="btnhh" class="button-link">
        <i class="fas fa-exclamation-triangle"></i> Thêm Nhân Viên</a>
</div>
            </div>
    ...
    <script>
        ...
        // Loop through all the menu links and add 'active' class to the current page's link
