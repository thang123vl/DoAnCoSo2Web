<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chinhsuathuoc.aspx.cs" Inherits="WebApplication1.chinhsuathuoc" %>
...
<div class="menu">
    ...
    <div class="form-container">
        <h1>TÊN THUỐC <%= suathuoc.TenThuoc %></h1>
        <form id="addThuocForm" runat="server" method="post">
            <div class="form-group">
                <label for="TenThuoc">Tên Thuốc Cần Chỉnh</label>
                <input type="text" id="TenThuoc" name="TenThuoc" runat="server" required />
            </div>
                   <div class="form-group">
                    <label for="MaDM">Thể loại thuốc</label>
                    <asp:DropDownList id="MaDM" runat="server" class="form-control" >
                    </asp:DropDownList>
                </div>
                 <div class="form-group">
                <label for="MaDM">Loại</label>
                 <asp:DropDownList ID="DonViDropDownList" runat="server">
                    <asp:ListItem Text="Viên" Value="Viên" />
                    <asp:ListItem Text="Hộp" Value="Hộp" />
                   </asp:DropDownList>
                 </div>
                 <div class="form-group">
                <label for="MaDM">Tình Trạng</label>
                 ...
                 <div class="form-group">
                    <label for="MaDM">Sửa Nhân Viên </label>
                    <asp:DropDownList id="MaNV" runat="server" class="form-control" >
                    </asp:DropDownList>
                </div>
                <div class="form-group">
                    <label for="MaDM">Sửa Nhà Cung6 Cấp</label>
                    <asp:DropDownList id="MaNCC" runat="server" class="form-control" >
                    </asp:DropDownList>
                </div>
            <div class="form-group">
